...
<table border = 1 width = "500" align = "center">
	...
	<tr><td>부서명</td>
	<td>	
		<input type = "text" name="empDeptName" value="${emp.empDeptName }">
	</td></tr>
	<tr><td>이메일</td>
	<td>
	...
	<td>	
		<input type = "text" name="hireDate"
			placeholder="2000-10-25" value="<fmt:formatDate value='${emp.hireDate}' type='date' pattern='yy-MM-dd'/>">
	</td></tr>
	<tr><td>급여</td>
	<td>
	...
	<tr><td colspan=2 align="center">
			<input type="submit" value = "직원수정완료"/>
